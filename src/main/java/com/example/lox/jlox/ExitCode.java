...
public enum ExitCode {
    EX_OK(0, "Execution was successful"), EX_USAGE(64, "The command was used incorrectly"),
    EX_DATAERR(65, "The input data was incorrect"), EX_NOINPUT(66, "An input file did not exist or was not readable"),
    EX_NOUSER(67, "The user specified did not exist"), EX_NOHOST(68, "The host specified did not exist."),
    EX_UNAVAILABLE(69, "A service is unavailable"), EX_SOFTWAR(70, "An internal software error has been detected"),
